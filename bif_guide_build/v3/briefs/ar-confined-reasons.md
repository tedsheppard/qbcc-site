# Element-page brief — ar-confined-reasons
**Title:** Confined to reasons in the payment schedule
**Breadcrumb:** Requirements of an adjudication response
**Anchor id:** `ar-confined-reasons`
**Output file:** `bif_guide_build/v3/pages/page_ar-confined-reasons.html`

## Statute scope note
Show s 82(4) and the surrounding subsections that fence off new reasons.
