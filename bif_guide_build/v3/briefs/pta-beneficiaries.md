# Element-page brief — pta-beneficiaries
**Title:** Subcontractor beneficiaries
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-beneficiaries`
**Output file:** `bif_guide_build/v3/pages/page_pta-beneficiaries.html`

## Extra guidance for this element
No annotated commentary. Cover: who is a subcontractor beneficiary, when they become one, related-entity rules.
