# Element-page brief — aa-form-registrar
**Title:** On the approved form to the registrar
**Breadcrumb:** Requirements of an adjudication application
**Anchor id:** `aa-form-registrar`
**Output file:** `bif_guide_build/v3/pages/page_aa-form-registrar.html`
