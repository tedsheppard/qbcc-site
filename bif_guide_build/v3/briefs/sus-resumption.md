# Element-page brief — sus-resumption
**Title:** Resumption when payment is made
**Breadcrumb:** Statutory suspension of works
**Anchor id:** `sus-resumption`
**Output file:** `bif_guide_build/v3/pages/page_sus-resumption.html`
