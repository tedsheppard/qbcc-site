# Element-page brief — pta-withdrawals-subbie
**Title:** Withdrawals to pay subcontractor beneficiaries
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-withdrawals-subbie`
**Output file:** `bif_guide_build/v3/pages/page_pta-withdrawals-subbie.html`

## Extra guidance for this element
No annotated commentary. Cover: when withdrawals to pay subbies are permitted, payment instruction process, order of payment.
