# Element-page brief — sc-supporting-cert
**Title:** Supporting certificate (s 124)
**Breadcrumb:** Valid subcontractor's charge
**Anchor id:** `sc-supporting-cert`
**Output file:** `bif_guide_build/v3/pages/page_sc-supporting-cert.html`
...
### `statute/chapter_4/section_124.txt`
```
# Source: BIF Act 2017 — Chapter 4
# Section 124 — Copy of notice of claim to the holder of a security
(1) This section applies if—
(a) a subcontractor gives a notice of claim to a person (the
recipient) obliged to pay money to a contractor under a
contract; and
Page 153 Current as at 27 April 2025

(b) a person other than the recipient holds a security for the
contract.
(2) The subcontractor must give a copy of the notice of claim to
the person who holds the security.
(3) If a copy of the notice of claim is not given as required under
subsection(2), the claimed subcontractor’s charge does not
attach to the security.
(4) To remove any doubt, it is declared that subsection(3) does
not affect a subcontractor’s charge to the extent it otherwise
attaches under this chapter.

```

## Annotated commentary (rewrite for PM audience; preserve case names / citations / block quotes verbatim)

### `annotated/section_124.txt`
```
# Annotated BIF Act source — Section 124
# Chapter: CHAPTER 4 – Subcontractors’ charges
# Section title: Copy of notice of claim to the holder of a security
# DOCX paragraphs: 4592-4600

[2 Com-BIFSOPA Heading 1] SECTION 124 – Copy of notice of claim to the holder of a security 
[1 BIFSOPA Heading] 124    Copy of notice of claim to the holder of a security 
[1.3 BIFSOPA level 1 (CDI)] This section applies if—
[1.4 BIFSOPA level 2 (CDI)] a subcontractor gives a notice of claim to a person (the recipient) obliged to pay money to a contractor under a contract; and 
[1.4 BIFSOPA level 2 (CDI)] a person other than the recipient holds a security for the contract. 
[1.3 BIFSOPA level 1 (CDI)] The subcontractor must give a copy of the notice of claim to the person who holds the security.
[1.3 BIFSOPA level 1 (CDI)] If a copy of the notice of claim is not given as required under subsection (2), the claimed subcontractor’s charge does not attach to the security. 
[1.3 BIFSOPA level 1 (CDI)] To remove any doubt, it is declared that subsection (3) does not affect a subcontractor’s charge to the extent it otherwise attaches under this chapter
