# Element-page brief — pta-when-required
**Title:** When a project trust is required
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-when-required`
**Output file:** `bif_guide_build/v3/pages/page_pta-when-required.html`

## Extra guidance for this element
No annotated commentary is available for the current Chapter 2 (Statutory trusts) regime. Work directly from the statute and the regulations. Focus on Chapter 2 Part 2 sections setting out eligibility (project value thresholds, contract type carve-outs).
