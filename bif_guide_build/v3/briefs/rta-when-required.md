# Element-page brief — rta-when-required
**Title:** When a retention trust is required
**Breadcrumb:** Retention trust accounts
**Anchor id:** `rta-when-required`
**Output file:** `bif_guide_build/v3/pages/page_rta-when-required.html`

## Extra guidance for this element
No annotated commentary. Cover: project value thresholds for retention trust requirement; relationship to project trust; contract type carve-outs.
