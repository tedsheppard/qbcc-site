# Element-page brief — sus-trigger-scheduled
**Title:** Trigger — failure to pay scheduled amount
**Breadcrumb:** Statutory suspension of works
**Anchor id:** `sus-trigger-scheduled`
**Output file:** `bif_guide_build/v3/pages/page_sus-trigger-scheduled.html`
