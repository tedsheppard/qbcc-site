# Element-page brief — e-judgment-debt
**Title:** Filing the certificate as a judgment debt
**Breadcrumb:** Enforcing an adjudicator's decision
**Anchor id:** `e-judgment-debt`
**Output file:** `bif_guide_build/v3/pages/page_e-judgment-debt.html`
