# Element-page brief — pc-request-payment
**Title:** Request payment
**Breadcrumb:** Requirements of a payment claim
**Anchor id:** `pc-request-payment`
**Output file:** `bif_guide_build/v3/pages/page_pc-request-payment.html`

## Statute scope note
Show only s 68(1)(c) and the introductory chapeau.
