# Element-page brief — pta-withdrawals-hc
**Title:** Withdrawals to pay the contracting party
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-withdrawals-hc`
**Output file:** `bif_guide_build/v3/pages/page_pta-withdrawals-hc.html`

## Extra guidance for this element
No annotated commentary. Cover: when the contracting party (head contractor) can be paid from the trust, what conditions apply.
