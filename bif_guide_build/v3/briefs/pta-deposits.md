# Element-page brief — pta-deposits
**Title:** Deposits into the project trust
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-deposits`
**Output file:** `bif_guide_build/v3/pages/page_pta-deposits.html`

## Extra guidance for this element
No annotated commentary. Cover: which payments must be deposited, timing of deposits, treatment of advance/upfront payments.
