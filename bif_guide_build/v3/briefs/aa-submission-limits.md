# Element-page brief — aa-submission-limits
**Title:** Submission limits and the no-new-reasons rule
**Breadcrumb:** Requirements of an adjudication application
**Anchor id:** `aa-submission-limits`
**Output file:** `bif_guide_build/v3/pages/page_aa-submission-limits.html`

## Statute scope note
Show s 79(3) (limits on submissions for standard/complex claims).
