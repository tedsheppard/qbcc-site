# Element-page brief — aa-within-time
**Title:** Within time (windows depend on trigger)
**Breadcrumb:** Requirements of an adjudication application
**Anchor id:** `aa-within-time`
**Output file:** `bif_guide_build/v3/pages/page_aa-within-time.html`

## Statute scope note
Show s 79(2) (the time-window subsection).
