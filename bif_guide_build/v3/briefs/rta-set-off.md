# Element-page brief — rta-set-off
**Title:** Set-off / contract claims against retention
**Breadcrumb:** Retention trust accounts
**Anchor id:** `rta-set-off`
**Output file:** `bif_guide_build/v3/pages/page_rta-set-off.html`

## Extra guidance for this element
No annotated commentary. Cover: when retention can be applied to contract claims, dispute mechanism.
