# Element-page brief — rta-releasing
**Title:** Releasing retention back to the subcontractor
**Breadcrumb:** Retention trust accounts
**Anchor id:** `rta-releasing`
**Output file:** `bif_guide_build/v3/pages/page_rta-releasing.html`

## Extra guidance for this element
No annotated commentary. Cover: when retention must be released, notification to subbie, dispute procedure.
