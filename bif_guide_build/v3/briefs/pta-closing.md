# Element-page brief — pta-closing
**Title:** Closing the project trust
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-closing`
**Output file:** `bif_guide_build/v3/pages/page_pta-closing.html`

## Extra guidance for this element
No annotated commentary. Cover: when a trust must be closed, distribution of remaining funds, notice of closure.
