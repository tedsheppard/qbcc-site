# Element-page brief — aa-identify
**Title:** Identify the payment claim and schedule
**Breadcrumb:** Requirements of an adjudication application
**Anchor id:** `aa-identify`
**Output file:** `bif_guide_build/v3/pages/page_aa-identify.html`
