# Element-page brief — sus-trigger-adjudicated
**Title:** Trigger — failure to pay adjudicated amount
**Breadcrumb:** Statutory suspension of works
**Anchor id:** `sus-trigger-adjudicated`
**Output file:** `bif_guide_build/v3/pages/page_sus-trigger-adjudicated.html`
