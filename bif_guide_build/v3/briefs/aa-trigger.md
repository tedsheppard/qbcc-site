# Element-page brief — aa-trigger
**Title:** Trigger condition (no schedule / partial payment / scheduled less than claimed)
**Breadcrumb:** Requirements of an adjudication application
**Anchor id:** `aa-trigger`
**Output file:** `bif_guide_build/v3/pages/page_aa-trigger.html`

## Statute scope note
Focus on s 79(1) and the related s 78 trigger.
