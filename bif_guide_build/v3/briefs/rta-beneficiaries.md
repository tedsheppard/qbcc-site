# Element-page brief — rta-beneficiaries
**Title:** Beneficiaries (whose retention it is)
**Breadcrumb:** Retention trust accounts
**Anchor id:** `rta-beneficiaries`
**Output file:** `bif_guide_build/v3/pages/page_rta-beneficiaries.html`

## Extra guidance for this element
No annotated commentary.
