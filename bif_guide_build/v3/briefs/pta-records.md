# Element-page brief — pta-records
**Title:** Records and reporting
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-records`
**Output file:** `bif_guide_build/v3/pages/page_pta-records.html`

## Extra guidance for this element
No annotated commentary. Cover: bookkeeping requirements, trust account reviews / audits, retention of records.
