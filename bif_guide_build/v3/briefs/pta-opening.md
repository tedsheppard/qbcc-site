# Element-page brief — pta-opening
**Title:** Opening the project trust account
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-opening`
**Output file:** `bif_guide_build/v3/pages/page_pta-opening.html`

## Extra guidance for this element
No annotated commentary. Cover: timing for opening, financial institution requirements, account name requirements, notification of opening.
