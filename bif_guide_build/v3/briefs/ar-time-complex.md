# Element-page brief — ar-time-complex
**Title:** Within time — complex claims (15 + 15 BD)
**Breadcrumb:** Requirements of an adjudication response
**Anchor id:** `ar-time-complex`
**Output file:** `bif_guide_build/v3/pages/page_ar-time-complex.html`

## Statute scope note
Show s 83(1)(b) and s 83(2).
