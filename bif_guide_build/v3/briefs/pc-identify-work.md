# Element-page brief — pc-identify-work
**Title:** Identify the construction work
**Breadcrumb:** Requirements of a payment claim
**Anchor id:** `pc-identify-work`
**Output file:** `bif_guide_build/v3/pages/page_pc-identify-work.html`

## Statute scope note
Show only s 68(1)(a) and the introductory chapeau.
