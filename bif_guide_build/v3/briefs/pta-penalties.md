# Element-page brief — pta-penalties
**Title:** Penalties for non-compliance
**Breadcrumb:** Project trust accounts
**Anchor id:** `pta-penalties`
**Output file:** `bif_guide_build/v3/pages/page_pta-penalties.html`

## Extra guidance for this element
No annotated commentary. Survey the offence provisions in Chapter 2 — maximum penalties, executive officer liability, common compliance traps.
