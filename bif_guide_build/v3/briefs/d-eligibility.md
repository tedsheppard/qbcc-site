# Element-page brief — d-eligibility
**Title:** The adjudicator must be eligible
**Breadcrumb:** Requirements of an adjudicator's decision
**Anchor id:** `d-eligibility`
**Output file:** `bif_guide_build/v3/pages/page_d-eligibility.html`
...
### `statute/chapter_3/section_080.txt`
```
# Source: BIF Act 2017 — Chapter 3
# Section 80 — When adjudicator ineligible to adjudicate
An adjudicator is not eligible to adjudicate an adjudication
application if the adjudicator—
Page 109 Current as at 27 April 2025
...
### `annotated/section_080.txt`
```
# Annotated BIF Act source — Section 80
# Chapter: CHAPTER 3 – Progress payments
# Section title: When adjudicator ineligible to adjudicate
# DOCX paragraphs: 2465-2471

[2 Com-BIFSOPA Heading 1] SECTION 80 – When adjudicator ineligible to adjudicate 
[1 BIFSOPA Heading] 80    When adjudicator ineligible to adjudicate 
[1.1 BIFSOPA Body Text] An adjudicator is not eligible to adjudicate an adjudication application if the adjudicator— 
[1.4 BIFSOPA level 2 (CDI)] is a party to the construction contract to which the application relates; or 
[1.4 BIFSOPA level 2 (CDI)] has a conflict of interest as prescribed by regulation.
