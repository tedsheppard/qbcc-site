# Element-page brief — ec-costs
**Title:** Costs
**Breadcrumb:** Enforcing a subcontractor's charge
**Anchor id:** `ec-costs`
**Output file:** `bif_guide_build/v3/pages/page_ec-costs.html`
...
### `statute/chapter_4/section_138.txt`
```
# Source: BIF Act 2017 — Chapter 4
# Section 138 — When person prejudicially affected by a claim
Without limiting the circumstances in which a person may be
prejudicially affected by a claim of a subcontractor’s charge, a
person is taken to be prejudicially affected by the claim if—
(a) because of the claim—
(i) the payment of an amount to which the person is
entitled is delayed or otherwise affected; or
(ii) the release of a security for a contract given by or
for the person is delayed or otherwise affected; and
(b) the person is the contractor or a subcontractor for a
higher subcontract; and
(c) under the contract or higher subcontract, the person has
already paid another person an amount for work the
subject of the claim.
Page 165 Current as at 27 April 2025

```

### `statute/chapter_4/section_145.txt`
```
# Source: BIF Act 2017 — Chapter 4
# Section 145 — Costs
Costs of proceedings under this chapter as between party and
party are at the discretion of the court.

```

## Annotated commentary (rewrite for PM audience; preserve case names / citations / block quotes verbatim)

### `annotated/section_138.txt`
```
# Annotated BIF Act source — Section 138
# Chapter: CHAPTER 4 – Subcontractors’ charges
# Section title: When person prejudicially affected by a claim
# DOCX paragraphs: 4766-4774

[2 Com-BIFSOPA Heading 1] SECTION 138 – When person prejudicially affected by a claim 
[1 BIFSOPA Heading] 138    When person prejudicially affected by a claim 
[1.1 BIFSOPA Body Text] Without limiting the circumstances in which a person may be prejudicially affected by a claim of a subcontractor’s charge, a person is taken to be prejudicially affected by the claim if—
[1.4 BIFSOPA level 2 (CDI)] because of the claim—
[1.5 BIFSOPA level 3 (CDI)] the payment of an amount to which the person is entitled is delayed or otherwise affected; or
[1.5 BIFSOPA level 3 (CDI)] the release of a security for a contract given by or for the person is delayed or otherwise affected; and
[1.4 BIFSOPA level 2 (CDI)] the person is the contractor or a subcontractor for a higher subcontract; and 
[1.4 BIFSOPA level 2 (CDI)] under the contract or higher subcontract, the person has already paid another person an amount for work the subject of the claim.

```

### `annotated/section_145.txt`
```
# Annotated BIF Act source — Section 145
# Chapter: CHAPTER 4 – Subcontractors’ charges
# Section title: Costs
# DOCX paragraphs: 4830-4833

[2 Com-BIFSOPA Heading 1] SECTION 145 – Costs 
[1 BIFSOPA Heading] 145    Costs 
[1.1 BIFSOPA Body Text] Costs of proceedings under this chapter as between party and party are at the discretion of the court.
