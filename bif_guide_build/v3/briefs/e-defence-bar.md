# Element-page brief — e-defence-bar
**Title:** What the respondent cannot raise as a defence
**Breadcrumb:** Enforcing an adjudicator's decision
**Anchor id:** `e-defence-bar`
**Output file:** `bif_guide_build/v3/pages/page_e-defence-bar.html`
