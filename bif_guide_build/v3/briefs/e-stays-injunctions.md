# Element-page brief — e-stays-injunctions
**Title:** Stays and injunctions
**Breadcrumb:** Enforcing an adjudicator's decision
**Anchor id:** `e-stays-injunctions`
**Output file:** `bif_guide_build/v3/pages/page_e-stays-injunctions.html`
