# Element-page brief — rta-what-goes-in
**Title:** What money is held in retention trust
**Breadcrumb:** Retention trust accounts
**Anchor id:** `rta-what-goes-in`
**Output file:** `bif_guide_build/v3/pages/page_rta-what-goes-in.html`

## Extra guidance for this element
No annotated commentary. Cover: which cash retention amounts must be held in trust; treatment of bank guarantees.
