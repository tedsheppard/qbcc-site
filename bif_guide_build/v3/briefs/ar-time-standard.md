# Element-page brief — ar-time-standard
**Title:** Within time — standard claims (10 BD)
**Breadcrumb:** Requirements of an adjudication response
**Anchor id:** `ar-time-standard`
**Output file:** `bif_guide_build/v3/pages/page_ar-time-standard.html`
